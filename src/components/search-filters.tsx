          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Toutes les surfaces" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">Toutes les surfaces</SelectItem>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">
                  Prix ({filters.priceRange[0]} - {filters.priceRange[1]} DT/h)
                </label>
                <Slider
              ...
              {/* Capacity Filter */}
              <div className="space-y-2">
                <label className="text-sm font-medium">Capacité minimum</label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="">Toutes les capacités</SelectItem>
                    <SelectItem value="10">10+ joueurs</SelectItem>
                    <SelectItem value="14">14+ joueurs</SelectItem>
                    <SelectItem value="22">22+ joueurs</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
